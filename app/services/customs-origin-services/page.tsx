...
export const metadata = pageMetadata("China Export Customs & Origin Logistics Services", "Factory pickup, export declarations, shipping documents and China origin coordination for international cargo.", "/services/customs-origin-services");
